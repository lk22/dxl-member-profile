<div class="modal modal-xl fade" backdrop="false" id="addNewGameModal" tabindex="-1" aria-labelledby="addNewGameModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header"><h3>Tilknyt spil titel</h3></div>
      <div class="modal-body p-4">
        <div class="row create-game-form">
          <form action="#" method="POST" class="dxl-app-add-game-form">
              <div class="form-group game-title-field">
                <input type="text" name="game_name" placeholder="Indtast spillets titel her" required>
              </div>
          </form>
        </div>
