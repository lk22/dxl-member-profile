<div class="create-training-event-content" style="display:none">
    <?php 
        if ( ! $profile["profile"]->is_trainer ) {
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info">
                            Du skal have træner rettigheder for at kunne oprette et trænings event
                        </div>
                    </div>
                </div>
            <?php 
            ...
            ?>
                <form action="#" method="POST" class="create-training-event-form needs-validation"novalidate>
                    ...
                    <div class="form-group event-game-field">
                        <label for="event-game">Vælg spil</label>
